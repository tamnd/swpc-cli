...
Most of these come down to network reality or how swpc serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

swpc rate-limits like any public site. swpc already paces
...
Where a surface is gated, swpc reads a cookie or token you supply
...
`swpc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what swpc actually did
