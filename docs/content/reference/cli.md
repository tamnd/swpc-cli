...
```
swpc <command> [arguments] [flags]
```

Run `swpc <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `swpc/domain.go`.
